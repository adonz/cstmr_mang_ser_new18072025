	...
	public CustomerRelationDetailsDto getCustomerRelationDetailsById(Integer id) {
	  ...
	  public void deleteMapping(Integer id) {
	    ...
	    public CustomerRelationDetailsDto updateCustomerRelationDetails(Integer customerId, CustomerRelationDetailsDto dto) {
	        ...
	        // Preserve existing values if DTO fields are null
	        existing.setMaritalStatusId(dto.getMaritalStatusId() != null ? dto.getMaritalStatusId() : existing.getMaritalStatusId());
	        existing.setGenderId(dto.getGenderId() != null ? dto.getGenderId() : existing.getGenderId());
